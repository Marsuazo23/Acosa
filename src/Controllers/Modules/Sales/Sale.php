...
class Sale extends PublicController
{
    ...
    private function validateData(): bool
    {
        ...
        if (Validators::IsEmpty($this->viewData["discountPercent"])) {
            ...
            $this->innerError("discountPercent", "Debe ser un número mayor o igual a cero.");
        }

        if (Validators::IsEmpty($this->viewData["saleStart"])) {
            $this->innerError("saleStart", "Este campo es requerido.");
        }

        if (Validators::IsEmpty($this->viewData["saleEnd"])) {
            $this->innerError("saleEnd", "Este campo es requerido.");
        }
