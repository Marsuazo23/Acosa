...
class Usuario extends PublicController
{
    ...
    private function getBodyData()
    {
        ...
        // useractcod no se recibe ni envía ni muestra
    }
    ...
    private function prepareViewData()
    {
        ...
        // Nueva bandera para la vista
        $this->viewData["showPasswordField"] = ($this->viewData["mode"] === "INS");

        if ($this->viewData["mode"] !== "INS") {
            $this->viewData["userpswd"] = "**********";
            $this->viewData["userpswd_readonly"] = "readonly";  // Campo solo lectura
            $this->viewData["showPasswordField"] = ""; // para que se muestre el input
        } else {
            $this->viewData["userpswd"] = "";
            $this->viewData["userpswd_readonly"] = "";          // editable
            $this->viewData["showPasswordField"] = ""; // mostrar input
        }
