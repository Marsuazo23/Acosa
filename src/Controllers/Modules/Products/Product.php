...
class Product extends PublicController
{
    ...
    private function getDataFromDB()
    {
        ...
        if ($tmpProduct) {
            ...
            $this->viewData["stock"] = $tmpProduct["stock"];
        } else {
    ...
    private function getBodyData()
    {
        ...
        if (!isset($_POST["stock"])) {
            $this->throwError("Error: Falta el stock del producto.", "Falta el parámetro stock en POST");
        }
    ...
    private function validateData(): bool
    {
        ...
        if (Validators::IsEmpty($this->viewData["stock"])) {
            $this->innerError("stock", "Este campo es requerido.");
        } elseif (!is_numeric($this->viewData["stock"]) || $this->viewData["stock"] < 0) {
            $this->innerError("stock", "Debe ser un número mayor o igual a cero.");
        }
